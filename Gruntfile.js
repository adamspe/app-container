...
module.exports = function(grunt){
    ...
    grunt.registerTask('after-test',['sass','copy','build', 'deploy']);
    ...
    grunt.registerTask('deploy',function(){
        ...
        if(deployTo) {
            grunt.log.writeln('deploying to'.cyan, deployTo.green);
            grunt.log.writeln('dist'.cyan,dist.green);
            wrench.copyDirSyncRecursive(dist,deployTo,{
                forceDelete: true
            });
        }
    });
